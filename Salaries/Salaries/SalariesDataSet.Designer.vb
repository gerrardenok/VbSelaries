...
Partial Public Class SalariesDataSet
    ...
    Private Sub InitClass()
        ...
        Me.tableEmployersView = New EmployersViewDataTable(false)
        MyBase.Tables.Add(Me.tableEmployersView)
        Me.relationРаботник_Специальность = New Global.System.Data.DataRelation("Работник_Специальность", New Global.System.Data.DataColumn() {Me.tableРаботник.Код_отделаColumn}, New Global.System.Data.DataColumn() {Me.tableСпециальность.Код_специальностиColumn}, false)
    ...
    Private Sub InitExpressions()
        Me.EmployersView.Вид_ставкиColumn.Expression = "IIf([Ставка]=0, '0,5 ставки',IIf([Ставка]=1, 'Полная ставка',IIf([Ставка]=2, '0,2"& _ 
            "5 ставки', 'Неизвестные вид ставки')))"
    End Sub
    ...
    Partial Public Class РаботникDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddРаботникRow(ByVal Имя As String, ByVal Фамилия As String, ByVal Отчество As String, ByVal Дата_приёма As Date, ByVal Телефон As String, ByVal Номер_пасспорта As String, ByVal Стаж As Integer, ByVal Ставка As Byte, ByVal parentОтделRowByFK_Работник_Отдел As ОтделRow, ByVal parentСпециальностьRowByFK_Работник_Специальность As СпециальностьRow, ByVal Дата_увольнения As Date) As РаботникRow
            Dim rowРаботникRow As РаботникRow = CType(Me.NewRow,РаботникRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Имя, Фамилия, Отчество, Дата_приёма, Телефон, Номер_пасспорта, Стаж, Ставка, Nothing, Nothing, Дата_увольнения}
        ...
        Private Sub InitClass()
            ...
            Me.columnСтавка = New Global.System.Data.DataColumn("Ставка", GetType(Byte), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class EmployersViewDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployersViewRow(ByVal Имя As String, ByVal Фамилия As String, ByVal Отчество As String, ByVal Телефон As String, ByVal Специальность As String, ByVal Отдел As String, ByVal Ставка As Byte, ByVal Вид_ставки As String, ByVal Дата_приёма As Date, ByVal Номер_пасспорта As String, ByVal Стаж As Integer) As EmployersViewRow
            Dim rowEmployersViewRow As EmployersViewRow = CType(Me.NewRow,EmployersViewRow)
            Dim columnValuesArray() As Object = New Object() {Имя, Фамилия, Отчество, Телефон, Специальность, Отдел, Nothing, Ставка, Вид_ставки, Дата_приёма, Номер_пасспорта, Стаж}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployersViewRow(ByVal Имя As String, ByVal Фамилия As String, ByVal Отчество As String, ByVal Телефон As String, ByVal Специальность As String, ByVal Отдел As String, ByVal Ставка As Byte, ByVal Дата_приёма As Date, ByVal Номер_пасспорта As String, ByVal Стаж As Integer) As EmployersViewRow
            Dim rowEmployersViewRow As EmployersViewRow = CType(Me.NewRow,EmployersViewRow)
            Dim columnValuesArray() As Object = New Object() {Имя, Фамилия, Отчество, Телефон, Специальность, Отдел, Nothing, Ставка, Nothing, Дата_приёма, Номер_пасспорта, Стаж}
            rowEmployersViewRow.ItemArray = columnValuesArray
            Me.Rows.Add(rowEmployersViewRow)
            Return rowEmployersViewRow
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnКод_работника.Unique = true
            Me.columnСтавка.AllowDBNull = false
            Me.columnВид_ставки.ReadOnly = true
            Me.columnВид_ставки.Caption = "Вид ставки"
            Me.columnДата_приёма.AllowDBNull = false
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Sub InitExpressions()
            Me.Вид_ставкиColumn.Expression = "IIf([Ставка]=0, '0,5 ставки',IIf([Ставка]=1, 'Полная ставка',IIf([Ставка]=2, '0,2"& _ 
                "5 ставки', 'Неизвестные вид ставки')))"
        End Sub
    ...
    Partial Public Class РаботникRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Property Ставка() As Byte
            Get
                Return CType(Me(Me.tableРаботник.СтавкаColumn),Byte)
            End Get
            Set
    ...
    Partial Public Class EmployersViewRow
        ...
        Public Property Ставка() As Byte
            Get
                Return CType(Me(Me.tableEmployersView.СтавкаColumn),Byte)
            End Get
            Set
                Me(Me.tableEmployersView.СтавкаColumn) = value
            End Set
        End Property
        ...
        Public Property Вид_ставки() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Вид_ставки' in table 'EmployersView' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function IsВид_ставкиNull() As Boolean
            Return Me.IsNull(Me.tableEmployersView.Вид_ставкиColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetВид_ставкиNull()
            Me(Me.tableEmployersView.Вид_ставкиColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace SalariesDataSetTableAdapters
    ...
    Partial Public Class РаботникTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Ставка", Global.System.Data.SqlDbType.TinyInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Ставка", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Код_отдела", Global.System.Data.SqlDbType.BigInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Код_отдела", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Ставка", Global.System.Data.SqlDbType.TinyInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Ставка", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Ставка", Global.System.Data.SqlDbType.TinyInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Ставка", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Ставка", Global.System.Data.SqlDbType.TinyInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Ставка", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Код_отдела", Global.System.Data.SqlDbType.BigInt, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "Код_отдела", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Код_работника As Long, ByVal Original_Имя As String, ByVal Original_Фамилия As String, ByVal Original_Отчество As String, ByVal Original_Дата_приёма As Date, ByVal Original_Телефон As String, ByVal Original_Номер_пасспорта As String, ByVal Original_Стаж As Global.System.Nullable(Of Integer), ByVal Original_Ставка As Byte, ByVal Original_Код_отдела As Long, ByVal Original_Код_специальности As Long, ByVal Original_Дата_увольнения As Global.System.Nullable(Of Date)) As Integer
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(9).Value = CType(Original_Ставка,Byte)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal Имя As String, ByVal Фамилия As String, ByVal Отчество As String, ByVal Дата_приёма As Date, ByVal Телефон As String, ByVal Номер_пасспорта As String, ByVal Ставка As Byte, ByVal Код_отдела As Long, ByVal Код_специальности As Long, ByVal Дата_увольнения As Global.System.Nullable(Of Date)) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(6).Value = CType(Ставка,Byte)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Ставка As Byte,  _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Ставка,Byte)
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_Ставка,Byte)
    ...
    Partial Public Class EmployersViewTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Работник.Имя, Работник.Фамилия, Работник.Отчество, Работник.Дата_пр"& _ 
                ...
                "Работник.Код_работника, Работник.Ставка"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Работник INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                       Специальность ON Работник.Код_специальности = Специальнос"& _ 
                "ть.Код_специальности INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Отдел ON Работник.Код_"& _ 
                "отдела = Отдел.Код_отдела"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Работник.Дата_увольнения IS NULL)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        Public Overloads Overridable Function GetData() As SalariesDataSet.EmployersViewDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As SalariesDataSet.EmployersViewDataTable = New SalariesDataSet.EmployersViewDataTable(true)
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
    End Class
